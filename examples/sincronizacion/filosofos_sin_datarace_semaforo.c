/**
 * @file filosofos_sin_datarace_semaforo.c
 * @author Esteban De La Fuente Rubio, DeLaF (esteban[at]delaf.cl)
 * @version 2013-05-21
 *
 * Compilar con:
 *  $ make APP=filosofos_sin_datarace_semaforo
 *
 * Ejecutar con:
 *  $ ./filosofos_sin_datarace_semaforo
 */
...
{
	int p1 = MIN (palito1, palito2);
	int p2 = MAX (palito1, palito2);
	semaphore_wait (palitos[p1]);
	semaphore_wait (palitos[p2]);
}
